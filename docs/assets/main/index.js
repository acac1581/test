...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './Test1.ts'], function () {
  return {
    setters: [null, null],
    execute: function () {}
  };
    ...
    execute: function () {
      ...
      var Test1 = exports('Test1', (_dec = ccclass('Test1'), _dec(_class = /*#__PURE__*/function (_Component) {
        ...
        function Test1() {
          ...
          _this.tonAddressMerchant = __webpack_exports__Address.parse("0QCJhgYQw7SvqeeA3EBI_WOqvAVSZktSPvDxiXpi57hq86O2");
          _this.jettonMasterAddress = __webpack_exports__Address.parse("kQAHKkZApqaYljlkBEzhzIvVLB7rYLLJy6pZYrRgHafU-VOy");
          _this.Client = void 0;
          _this.currentWallet = void 0;
          _this.currentWalletString = void 0;
          _this.botToken = "7721688539:AAFtOEz4-SoNNlHEobNEXDXaxKOanxuMwKE";
        ...
        _proto.start = function start() {};
        _proto.GameFiCreate = function GameFiCreate() {
          // const vConsole = new VConsole();
          console.log('Hello world');
          this._GameFiCreate();
        };
        _proto._GameFiCreate = /*#__PURE__*/function () {
          var _GameFiCreate2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            var _this2 = this;
              ...
              while (1) switch (_context.prev = _context.next) {
                ...
                case 4:
                  ...
                  this._connectUI.onStatusChange(function (info) {
                    ...
                    if (info) {
                      _this2.currentWallet = __webpack_exports__Address.parse(info.account.address);
                      _this2.currentWalletString = __webpack_exports__Address.normalize(info.account.address);
                    }
                    _this2.updateConnect();
                  });
                  this.updateConnect();
          ...
          function _GameFiCreate() {
            return _GameFiCreate2.apply(this, arguments);
          }
          return _GameFiCreate;
        }();
