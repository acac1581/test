  ...
  (function () {
    ...
    !function (t, e) {
      ...
      var Bt = Object.freeze({
        ...
        function a(t, r, o) {
          var s;
          return e(this, a), (s = n.call(this)).connected = !1, s.recovered = !1, s.receiveBuffer = [], s.sendBuffer = [], s._queue = [], s.ids = 0, s.acks = {}, s.flags = {}, s.io = t, s.nsp = r, o && o.auth && (s.auth = o.auth), s._opts = i({}, o), s.io._autoConnect && s.open(), s;
        }
        ...
        return r(a, [{
          ...
          value: function (t) {
            ...
            t.push(function (t) {
              if (r === n._queue[0]) {
                var i = null !== t;
                if (i) r.tryCount > n._opts.retries && (n._queue.shift(), e && e(t));else if (n._queue.shift(), e) {
